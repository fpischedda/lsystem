...
class ReferencedField(Serializable):
    ...
    ID_FIELDS = ('id_field', )
    FIELDS = (Serializable.field('id_field'),
              Serializable.field('some_field'))

    def __init__(self, id_field, some_field):
    ...
    def get_by_reference(cls, id):
        ...
        return {'id_field': id['id_field'], 'some_field': 'some value'}
...
def test_reference_serialization():
    ...
    f = ReferencedField('some id', 'some value')
...
def test_reference_list_serialization():
    ...
    r1 = ReferencedField('referenced_in_list1', 'value1')
    r2 = ReferencedField('referenced_in_list2', 'value2')
